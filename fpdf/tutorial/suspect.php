...
function BasicTable()
{
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(50,8,$row->postnom,1,0,'C');
		// $this->Cell(30,8,$row->datenaissance,1,0,'C');
		$this->Cell(25,8,$row->sexe,1,0,'C');
		$this->Cell(30,8,$row->numtel,1,0,'C');
	
		$this->Cell(30,8,$row->ville,1,0,'C');
		$this->Ln();
