...
function BasicTable()
{
	...
	$this->Image('a.PNG',5,4,190);
		$this->Ln();
		$this->Cell(40,6,'NOM',1,0,'C');
		$this->Cell(40,6,'POST NOM',1,0,'C');
		$this->Cell(30,6,'DATE NAISS',1,0,'C');
		$this->Cell(20,6,'SEXE',1,0,'C');
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(40,8,$row->postnom,1,0,'C');
		$this->Cell(30,8,$row->datenaissance,1,0,'C');
		$this->Cell(20,8,$row->sexe,1,0,'C');
